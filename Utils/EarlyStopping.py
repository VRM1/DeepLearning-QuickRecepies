...
class EarlyStopping:
    ...
    def __init__(self, patience=7, verbose=False, delta=0.005, typ='loss', write_all=False):
        """
        Args:
    ...
    def save_checkpoint(self, metric, model, optimizer, pth_to_write):
        ...
        state = {'metric':metric, 'weights': model.state_dict(), 'optimizer': optimizer.state_dict()}
